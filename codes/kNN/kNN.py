...
def handwritingClassTest():
    hwLabels = []
    filePath = pathlib.Path(__file__).parent / '../../resources/trainingDigits'
    trainingFileList = listdir(filePath)  # load the training set
    ...
    for i in range(m):
        ...
        filePath = pathlib.Path(__file__).parent / '../../resources/trainingDigits/%s'
        trainingMat[i, :] = img2vector(str(filePath) % fileNameStr)
    ...
    for i in range(mTest):
        ...
        vectorUnderTest = img2vector(str(filePath) % fileNameStr)
